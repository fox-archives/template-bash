...
This template includes working code for a "Fox Tracker" that is usable as a library and a command line utility. Succinctly, this application allows a user to track and change the number of hypothetical foxes (stored in `$XDG_STATE_HOME/fox-tracker/total`)
